...
# Unit tests for StableDiffusion::DefaultApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DefaultApi' do
  before do
    # run before each test
    @instance = StableDiffusion::DefaultApi.new
  end
  ...
  describe 'test an instance of DefaultApi' do
    it 'should create an instance of DefaultApi' do
      expect(@instance).to be_instance_of(StableDiffusion::DefaultApi)
    end
  end
  ...
  # unit tests for get_extensions_list_sdapi_v1_extensions_get
  # Get Extensions List
  # @param [Hash] opts the optional parameters
  # @return [Array<ExtensionItem>]
  describe 'get_extensions_list_sdapi_v1_extensions_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for refresh_vae_sdapi_v1_refresh_vae_post
  # Refresh Vae
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'refresh_vae_sdapi_v1_refresh_vae_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for stream_stream_session_hash_run_component_id_get
  # Stream
  # @param session_hash 
  # @param run 
  # @param component_id 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'stream_stream_session_hash_run_component_id_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
