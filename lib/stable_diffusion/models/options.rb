...
module StableDiffusion
  class Options
    ...
    attr_accessor :save_images_replace_action
    ...
    attr_accessor :save_incomplete_images

    # Play notification sound after image generation
    attr_accessor :notification_audio

    # Notification sound volume
    attr_accessor :notification_volume
    ...
    # Restore faces
    attr_accessor :face_restoration
    ...
    attr_accessor :auto_launch_browser
    ...
    attr_accessor :show_gradio_deprecation_warnings
    ...
    attr_accessor :hide_ldm_prints

    # Print stack traces before exiting the program with ctrl+c.
    attr_accessor :dump_stacks_on_signal

    # Allow http:// and https:// URLs for input images in API
    attr_accessor :api_enable_requests

    # Forbid URLs to local resources
    attr_accessor :api_forbid_local_requests

    # User agent for requests
    attr_accessor :api_useragent
    ...
    attr_accessor :sd_checkpoints_limit

    # Only keep one model on device
    attr_accessor :sd_checkpoints_keep_in_cpu
    ...
    attr_accessor :hires_fix_refiner_pass
    ...
    attr_accessor :sd_vae_explanation
    ...
    attr_accessor :sd_vae_overrides_per_model_preferences

    # Automatically revert VAE to 32-bit floats
    attr_accessor :auto_vae_precision

    # VAE type for encode
    attr_accessor :sd_vae_encode_method

    # VAE type for decode
    attr_accessor :sd_vae_decode_method
    ...
    attr_accessor :img2img_extra_noise
    ...
    attr_accessor :img2img_sketch_default_brush_color

    # Inpaint mask brush color
    attr_accessor :img2img_inpaint_mask_brush_color

    # Inpaint sketch initial brush color
    attr_accessor :img2img_inpaint_sketch_default_brush_color
    ...
    attr_accessor :img2img_batch_show_results_limit
    ...
    attr_accessor :persistent_cond_cache

    # Batch cond/uncond
    attr_accessor :batch_cond_uncond
    ...
    attr_accessor :use_old_scheduling
    ...
    attr_accessor :extra_networks_dir_button_function
    ...
    attr_accessor :extra_networks_card_order_field

    # Default order for Extra Networks cards
    attr_accessor :extra_networks_card_order
    ...
    attr_accessor :keyedit_delimiters_whitespace
    ...
    # Gallery height
    attr_accessor :gallery_height

    # Compact prompt layout
    attr_accessor :compact_prompt_box
    ...
    attr_accessor :sd_checkpoint_dropdown_use_short
    ...
    attr_accessor :txt2img_settings_accordion

    # Settings in img2img hidden under Accordion
    attr_accessor :img2img_settings_accordion
    ...
    attr_accessor :gradio_themes_cache
    ...
    attr_accessor :infotext_explanation
    ...
    attr_accessor :add_vae_name_to_info

    # Add VAE hash to infotext
    attr_accessor :add_vae_hash_to_info
    ...
    attr_accessor :infotext_skip_pasting
    ...
    attr_accessor :live_preview_allow_lowvram_full
    ...
    attr_accessor :live_preview_fast_interrupt

    # Show Live preview in full page image viewer
    attr_accessor :js_live_preview_in_modal_lightbox
    ...
    attr_accessor :sgm_noise_multiplier
    ...
    attr_accessor :postprocessing_existing_caption_action
    ...
    attr_accessor :lora_in_memory_limit
    ...
    attr_accessor :canvas_auto_expand
    ...
    attr_accessor :settings_in_ui

    # Settings for txt2img
    attr_accessor :extra_options_txt2img

    # Settings for img2img
    attr_accessor :extra_options_img2img

    # Number of columns for added settings
    attr_accessor :extra_options_cols
