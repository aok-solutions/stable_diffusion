...
module StableDiffusion
  class Flags
    ...
    attr_accessor :use_ipex

    # disable an optimization that reduces RAM use when loading a model
    attr_accessor :disable_model_loading_ram_optimization
    ...
    attr_accessor :disable_extra_extensions

    # if load a model at web start, only take effect when --nowebui
    attr_accessor :skip_load_model_at_start
