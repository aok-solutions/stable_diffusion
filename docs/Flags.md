...
**log_startup** | **BOOLEAN** | launch.py argument: print a detailed log of what&#x27;s happening at startup | [optional] [default to false]
...
**dump_sysinfo** | **BOOLEAN** | launch.py argument: dump limited sysinfo file (without information about extensions, options) to disk and quit | [optional] [default to false]
